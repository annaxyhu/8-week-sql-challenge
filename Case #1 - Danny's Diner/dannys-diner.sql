...
Skills Targetted: Database creation, querying
...
;
	...
	-- Output: A = sushi & curry, B = curry, C = ramen
...
LIMIT 1
;
	-- Output: most purchased is ramen at 8 times
...
;
	...
	-- Output: A = ramen, B = all items, C = ramen
...
GROUP BY customer_id;
	...
	-- Output: A = 2 items & $25, B = 3 items & $40, C = 3 items & $36

-- 9. If each $1 spent equates to 10 points and sushi has a 2x points multiplier - 
-- 	  how many points would each customer have?

-- assumes purchases on join date are not included in the points calculation
...
GROUP BY customer_id;
	...
	-- Output: A has 360 points, B has 440 points, C has 0 points
...
-- assuming 2x active period ends 7 afters after the join date (ex. active from 2021-01-09 to 2021-01-16)
